...
def main(args):
    ...
    if args.data_name == "LEVIR_CC":
        ...
        nochange_list = [
            "Nothing has changed ",
            "There is no difference ",
            "All remained the same " "Everything remains the same ",
            "Nothing has changed in this area ",
            "Nothing changed in this area " "No changes in this area ",
            "No change was made ",
            "There is no change to mention ",
            "No changes to mention " "No changed to mention ",
            "No difference in this area ",
            "No change to mention " "No change was made ",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Remote_Sensing_Image_Change_Captioning"
    )

    # Data parameters
    parser.add_argument(
        "--data_folder",
        default="/Users/ayushbhauwala/Documents/Columbia/Sem 1/DL for CV/project/experimenting/levir_cc/Levir-CC-dataset/images",
        help="folder with data files",
    )
    parser.add_argument(
        "--list_path", default="./data/LEVIR_CC/", help="path of the data lists"
    )
    parser.add_argument(
        "--token_folder",
    ...
    parser.add_argument(
        "--allow_unk", type=int, default=1, help="path of the data lists"
    )
    parser.add_argument(
        "--data_name", default="LEVIR_CC", help="base name shared by data files."
    )
    parser.add_argument(
        "--checkpoint",
        default="LEVIR_CC_batchsize_32_resnet101.pth",
    ...
    parser.add_argument(
        "--network",
        default="resnet101",
        help="define the encoder to extract features:resnet101,vgg16",
    )
    ...
    parser.add_argument("--savepath", default="./Pretrained_models/")
